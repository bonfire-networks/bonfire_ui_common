...
ComposerHooks.ScreenSize = {
	mounted() {
		...
		// boundaries general
		const boundaries_general = composerWrapper.getElementsByClassName(
			"boundaries_general_access",
		)[0];
		// boundaries preview
		const boundaries_preview = document.getElementById(
			"preview_boundaries_container",
		);
		// set boundaries
		// const set_boundaries = document.getElementById("set_boundaries");
		const set_boundaries =
			composerWrapper.getElementsByClassName("set_boundaries")[0];
