...
function shouldHandlePreviewClick(e, trigger, pointerState, uri) {
  ...
  if (!trigger && !window.liveSocket && !uri) return false;
...
let PreviewActivity = {
  ...
  mounted() {
    ...
    this.handleClick = (e) => {
      ...
      if (shouldHandlePreviewClick(e, trigger, this.pointerState, uri)) {
        if (window.liveSocket && trigger) {
