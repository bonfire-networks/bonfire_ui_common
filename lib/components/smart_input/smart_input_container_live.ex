defmodule Bonfire.UI.Common.SmartInputContainerLive do
  ...
  def mount(_params, session, socket) do
    ...
    # subscribe
    assigns[:context][:csrf_token] #[:session_topic_id]
    |> info("session_topic")
    ...
    {:ok, socket
        ...
        |> assign_new(:smart_input_as, fn -> SmartInputLive.set_smart_input_as(assigns[:thread_mode], assigns) end)
        ...
        |> info("smart_input_sticky assigns via session"),
      layout: false
    }
  end
