if Code.ensure_loaded?(LiveViewNative.Component) do
  defmodule Bonfire.UI.Common.CoreComponents.SwiftUI do
    ...
    of the `BonfireUmbrellaWeb.CoreComponents` functions you should expect identical functionality for similarly named
    ...
    def translate_error({msg, opts}) do
      ...
      if count = opts[:count] do
        Gettext.dngettext(BonfireUmbrellaWeb.Gettext, "errors", msg, msg, count, opts)
      else
        Gettext.dgettext(BonfireUmbrellaWeb.Gettext, "errors", msg, opts)
      end
    end
