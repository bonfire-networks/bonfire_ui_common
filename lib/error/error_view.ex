defmodule Bonfire.UI.Common.ErrorView do
  ...
  def render("500.html", assigns) do
    show_error(500, (reason(assigns) || "Please try again or contact the instance admins.")<>"\n<p><img class='mx-auto' src='https://media2.giphy.com/media/QMHoU66sBXqqLqYvGO/giphy.gif'/>", true)
  end
