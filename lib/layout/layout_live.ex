    ...
    >
      ...
      <div class={
        ...
        >
          ...
          />
          <nav
            class="hidden w-full mt-4 md:flex gap-4 flex-col overflow-y-auto max-h-[calc(var(--inner-window-height)_-_134px)] min-h-[calc(var(--inner-window-height)_-_134px)]"
            role="navigation"
